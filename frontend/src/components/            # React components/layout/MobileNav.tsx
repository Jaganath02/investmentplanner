      ...
      <div className="grid grid-cols-5 h-16">
        ...
        >
          <svg
            ...
            stroke="currentColor"
          >
            // frontend/src/components/layout/MobileNav.tsx (continued)
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
              strokeWidth={2}
        ...
        <Link
          to="/investments"
          className={`flex flex-col items-center justify-center ${
            isActive('/investments') ? 'text-indigo-600' : 'text-gray-500'
          }`}
        >
          <svg
            className="h-6 w-6"
        ...
        <Link
          ...
          className={`flex flex-col items-center justify-center ${
            ...
            location.pathname.includes('/tax-calculator') || 
            location.pathname.includes('/buy-vs-rent') 
              ? 'text-indigo-600' 
              : 'text-gray-500'
          }`}
        >
